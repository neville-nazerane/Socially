...
using Socially.Server.Entities.NoSql;
...
var comment = post?.Comments?.SingleOrDefault(c => c.Id == new Guid("bddc23d0-2bff-4994-b178-2a052ba624c9"));
...
//var project = Builders<Post>.Projection.Expression(p => p.Comments);
