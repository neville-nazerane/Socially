...
namespace Socially.Mobile.Logic.Models.Mappings
{
    ...
    public static class PasswordResetModelMappingExtensions 
    {
        ...
        public static async Task<List<Socially.Models.PasswordResetModel>> ToModel(this Task<ICollection<Socially.Mobile.Logic.Models.PasswordResetModel>> modelTask)
            => (await modelTask).ToModel();

        public static List<Socially.Models.PasswordResetModel> ToModel(this ICollection<Socially.Mobile.Logic.Models.PasswordResetModel> model)
            => model == null ? null : model.Select(m => m.ToModel()).ToList();
        ...
        public static async Task<List<Socially.Mobile.Logic.Models.PasswordResetModel>> ToMobileModel(this Task<ICollection<Socially.Models.PasswordResetModel>> modelTask)
            => (await modelTask).ToMobileModel();

        public static List<Socially.Mobile.Logic.Models.PasswordResetModel> ToMobileModel(this ICollection<Socially.Models.PasswordResetModel> model)
            => model == null ? null : model.Select(m => m.ToMobileModel()).ToList();   
