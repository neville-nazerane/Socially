...
namespace Socially.Mobile.Logic.Models.Mappings
{
    ...
    public static class SignUpModelMappingExtensions 
    {
        ...
        public static async Task<List<Socially.Models.SignUpModel>> ToModel(this Task<ICollection<Socially.Mobile.Logic.Models.SignUpModel>> modelTask)
            => (await modelTask).ToModel();

        public static List<Socially.Models.SignUpModel> ToModel(this ICollection<Socially.Mobile.Logic.Models.SignUpModel> model)
            => model == null ? null : model.Select(m => m.ToModel()).ToList();
        ...
        public static async Task<List<Socially.Mobile.Logic.Models.SignUpModel>> ToMobileModel(this Task<ICollection<Socially.Models.SignUpModel>> modelTask)
            => (await modelTask).ToMobileModel();

        public static List<Socially.Mobile.Logic.Models.SignUpModel> ToMobileModel(this ICollection<Socially.Models.SignUpModel> model)
            => model == null ? null : model.Select(m => m.ToMobileModel()).ToList();   
